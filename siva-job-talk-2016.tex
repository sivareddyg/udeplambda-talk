...
\only<1>{\vspace{4.8em}\includegraphics[trim=0em 3.5em 14em 5.5em,clip=true,scale=1.2
  ]{figures/dependency-word-order-telugu}}
\only<2>{\includegraphics[trim=0em 3.5em 14em 0.5em,clip=true,scale=1.2
  ]{figures/dependency-word-order-telugu}
  \vspace{-0.5em}}
\end{center}
\end{frame} 
...
\begin{frame}
\frametitle{WebQuestions in English, German, Spanish}
...
\begin{frame}  
\frametitle{Comparision with CCG}
\centering
