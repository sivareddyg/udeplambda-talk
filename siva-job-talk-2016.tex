...
\hlight{School of Informatics\\The University of Edinburgh}\\
}
...
\vspace{-1em}
\begin{center}
\only<1>{\includegraphics[trim=2em 5em 12em 0em,clip=true,scale=1.0]{figures/dependency-reduced-relative}}
\only<2>{\includegraphics[trim=2em 2em 12em 0em,clip=true,scale=1.0]{figures/dependency-reduced-relative-trace}}
\only<3,4>{\includegraphics[trim=2em 5em 12em 0em,clip=true,scale=1.0]{figures/dependency-reduced-relative-box1}}
\only<5,6>{\includegraphics[trim=2em 5em 12em 0em,clip=true,scale=1.0]{figures/dependency-reduced-relative-box2}}
\only<7>{\includegraphics[trim=2em 5em 12em 0em,clip=true,scale=1.0]{figures/dependency-reduced-relative-box3}}
\only<8->{\includegraphics[trim=1.5em 5em 12em 0em,clip=true,scale=1.0]{figures/dependency-reduced-relative-box4}}

\only<3>{\includegraphics[trim=31em 51.5em 3em 0em,clip=true,scale=0.9]{figures/dependency-reduced-relative-derivation}\vspace{6.5em}}
\only<4>{\includegraphics[trim=31em 45em 3em 0em,clip=true,scale=0.9]{figures/dependency-reduced-relative-derivation}}
\only<5>{\includegraphics[trim=20em 51.5em 6em 0em,clip=true,scale=0.9]{figures/dependency-reduced-relative-derivation1}\vspace{6.5em}}
\only<6>{\includegraphics[trim=20em 45em 6em 0em,clip=true,scale=0.9]{figures/dependency-reduced-relative-derivation1}}
\only<7>{\includegraphics[trim=9em 45em 9em 0em,clip=true,scale=0.9]{figures/dependency-reduced-relative-derivation2}}
...
\begin{frame}
\frametitle{Freebase Semantic Parsing [Reddy et al., 2014]}
% TODO add arrows.
