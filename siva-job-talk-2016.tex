...
%\centering
%\vspace{0.6em}
\only<1>{\includegraphics[trim=1em 12em 52.2em 0.5em,clip=true,scale=0.51]{figures/deplambda_results_plot}}
\only<2>{\includegraphics[trim=1em 12em 48.8em 0.5em,clip=true,scale=0.51]{figures/deplambda_results_plot}}
\only<3>{\includegraphics[trim=1em 12em 45.3em 0.5em,clip=true,scale=0.51]{figures/deplambda_results_plot}}
\only<4>{\includegraphics[trim=1em 12em 42em 0.5em,clip=true,scale=0.51]{figures/deplambda_results_plot}}
\only<5>{\includegraphics[trim=1em 12em 38.4em 0.5em,clip=true,scale=0.51]{figures/deplambda_results_plot}}
...
\begin{frame}
  \frametitle{UDepLambda: \only<1,3,5>{\alert{Present}} \only<2,4,6>{\color{darkgreen}Towards ...}}
\large
