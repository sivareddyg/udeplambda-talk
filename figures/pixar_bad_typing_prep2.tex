...
\small $\alpha$ \& \small \color{red} $\alpha \xrightarrow[]{dobj} (\gamma \xrightarrow[]{prep} (\alpha \xrightarrow[]{nsubj} \beta))$ \& \small $\alpha$ \& \small \color{red} $\alpha \xrightarrow[]{pobj} \gamma$ \& \small $\alpha$ \\
