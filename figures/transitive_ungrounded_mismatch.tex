...
thick,dashed,sloped,above,font=\sffamily\scshape,bend right=20},
  ...
  \draw [mediatorToEntity] (e2) edge node[below] {director\\.arg0}  (eCompany);
  \draw [mediatorToEntity] (e2) edge node[below] {director\\.of} (ePixar);
