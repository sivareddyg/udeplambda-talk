...
(e1997) {1997}; \\
  ...
  \draw [mediatorToEntity] (m1) edge node {}  (eCameron);
  \draw [mediatorToEntity] (m1) edge node
{} 
(eTitanic);
  
  \draw [mediatorToEntity] (m2) edge node {}  (e1997);
  \draw [mediatorToEntity] (m2) edge node[rotate=180] {} 
(eTitanic);
  
  \draw [mediatorToEntity] (m3) edge node[below] {} 
(eCameron);
  \draw [mediatorToEntity] (m3) edge node[below] {}  (e1997);
