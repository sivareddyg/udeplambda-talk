...
\frametitle{This Talk}
\vspace{4em}
\only<1>{\includegraphics[scale=0.82]{figures/outline2.pdf}}
\only<2>{\includegraphics[scale=0.82]{figures/outline3.pdf}}
\only<3>{\includegraphics[scale=0.82]{figures/outline7.pdf}}
\only<4>{\includegraphics[scale=0.82]{figures/outline8.pdf}}
%\only<5>{\includegraphics[scale=0.82]{figures/outline5.pdf}}
%\only<6>{\includegraphics[scale=0.82]{figures/outline8.pdf}}
%\only<7>{\includegraphics[scale=0.82]{figures/outline7.pdf}}
\end{frame}
...
\only<2>{\includegraphics[trim=7em 8em 7em 0em,clip=true,scale=1.1]{figures/dependency-transitive-derivation_dobj}}
\end{center}
\end{frame}
...
\only<1-3>{\includegraphics[trim=2em 9.4em 10em 0em,clip=true,scale=1.3]{figures/pixar_nsubj}}
%\only<4->{\includegraphics[trim=2em 9.4em 10em 0em,clip=true,scale=1.3]{figures/pixar_nsubj_phrase}}
...
\only<1>{\includegraphics[trim=3em 16em 3em 0em,clip=true,scale=1.1]{figures/dependency-transitive-derivation-nsubj}\vspace{8em}}
...
\only<2>{\includegraphics[trim=3em 8em 3em 0em,clip=true,scale=1.1]{figures/dependency-transitive-derivation-nsubj}}
\only<3>{\includegraphics[trim=3em 8em 3em 0em,clip=true,scale=1.1]{figures/dependency-transitive-derivation_full}}
\end{center}
\end{frame}
...
\begin{frame}
\frametitle{Knowledge-base Question Answering}
\framesubtitle{[\small Zelle and Mooney 1996, Berant et al. 2013, Kwiatkowski et al. 2013]}
\vspace{-1em}
\begin{columns}
...
\matrix{
    \node[myboxNL] (NL) {\textbf{Question} \\ Which company acquired Pixar?}; \\ 
    \only<2->{\node[myboxMR] (MR) [text=black!30] {
    \textbf{Grounded Logical Form} \\ $\lambda x.\exists e.\;\mbox{organization}(x) \wedge \mbox{acquisition}(e) \wedge \mbox{acquiring\_company}(e,x) \wedge \mbox{company\_acquired}(e,\mbox{Pixar})$ }; \\}
    \node[myboxAns] (Ans) {\textbf{Answer} \\ \{The Walt Disney Company\}}; \\
    };
\end{tikzpicture}
...
\vspace{-4.2cm} \\ \hspace{2cm} \bf Latent
 };
\end{tikzpicture}}
\end{figure}
 \end{column}
...
\begin{columns}
  \begin{column}{0.58\textwidth}
   \centering
   \only<1>{\includegraphics[width=\textwidth]{figures/transitive_ungrounded_mismatch}\\ Ungrounded Graph}
   %\only<2>{\includegraphics[width=\textwidth]{figures/transitive_ungrounded_mismatch2}\\ Ungrounded Graph}
   \only<2>{\includegraphics[width=\textwidth]{figures/transitive_ungrounded_mismatch1}\\ Ungrounded Graph}
   \only<3>{\includegraphics[width=\textwidth]{figures/transitive_ungrounded_mismatch_collapsed}\\ Ungrounded Graph}
  \end{column}
...
% , e.g., \textit{nsubj} is \textbf{not} always agent (arg$_1$)
\vspace{1em}
\begin{itemize}
